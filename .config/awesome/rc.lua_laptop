...
-- LAPTOP
	...
	function () awful.util.spawn_with_shell("nitrogen --set-zoom-fill --random $HOME/files/wallpaper/1920x1080") end,
...
--[[
    ...
    { rule = { class = "firefox" },
      properties = { screen = 2, tag = "2", fullsreen = true }},
...
--]]
    ...
    { rule = { class = "firefox" },
      properties = { screen = 1, tag = "2", fullsreen = true }},
...
--]]
	...
	-- Laptop
        ...
        -- GUI Text Editor / GUI File Explorer
...
--[[
    ...
    { rule = { instance = "veracrypt" },
      properties = { screen = 2, tag = "9", floating = true }},
...
awful.spawn.with_shell("sleep 3 && rfkill block bluetooth")
...
awful.spawn.with_shell("redshift-gtk -c ~/.config/redshift/redshift.conf")
        -- Others
--awful.spawn.with_shell("redshift-gtk -l 40.7167:-74.00597")
--awful.spawn.with_shell("redshift-gtk -l 40.7167:-74.00597 -b 0.6")
