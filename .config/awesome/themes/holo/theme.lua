...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/holo"
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/holo/icons-holo"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/wallpaper/wall-holo.png"
