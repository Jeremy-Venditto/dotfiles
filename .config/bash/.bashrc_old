...
alias rewind='mpc seek -00:00:15'
alias forward='mpc seek +00:00:15'
#alias lm='ls | more"
alias py='python'
...
alias awepaper='cd ~/scripts && ./nitrogen.sh'
alias piconf='cd ~/.config/picom && nano picom.conf'
alias bin='cd ~/.local/bin && ls'
alias trim='journalctl -u fstrim'
alias wallpaper='cd ~/files/stuff/images/wallpaper'

## My Programs ##
alias cw='~/programming/bash/nitrogen/nitrogen-change-all.sh'
alias gccp='-lstdc++'
alias niconf='cd ~/.config/nitrogen/'
alias pkginfo3='~/scripts/pkginfo.sh'
alias pkginfo2='~/scripts/pkginfo2.sh'
alias pkginfo='~/scripts/pkginfo-all.sh'
##  GPG  ##
